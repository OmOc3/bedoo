...
export function LogoMarkSvg({ className, title = "Mawqi3" }: LogoSvgProps) {
  return (
    <svg
      aria-label={title}
    ...
    >
      <path d={MAWQI3_MARK_PATH} fill="currentColor" fillRule="evenodd" />
    </svg>
  );
}
