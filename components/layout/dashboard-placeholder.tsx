  ...
  return (
    <main className="min-h-dvh px-4 py-5 sm:px-6">
      <section className="mx-auto flex min-h-[calc(100dvh-2.5rem)] w-full max-w-4xl flex-col gap-5">
        <div className="flex flex-col gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-control sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            <span className="inline-flex w-fit rounded-full bg-[var(--primary-soft)] px-3 py-1 text-xs font-bold text-[var(--primary-strong)]">
