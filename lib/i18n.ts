...
const en = {
  ...
  managerHome: {
    ...
    statTodayTasks: "Today tasks",
    recentReports: "Latest reports",
    viewAll: "View all",
    colTime: "Time",
    colStation: "Station",
  ...
  teamPage: {
    ...
    supervisorDescription: "View team members by role with search, filters, and creating new accounts.",
    ...
    roleSupervisorDesc: "Daily operations and reviewing tickets and orders.",
