const exactArabicToEnglishEntries = [
  ...
  ["التقارير", "Reports"],
  ["تقارير المدير", "Manager report review"],
  ...
  ["برنامج التنفيذ — أنواع الآفات", "Treatment program: pest types"],
  ["ملاحظات الفني", "Technician notes"],
  ["حفظ تعديلات التنفيذ", "Save execution details"],
  ...
  ["لمحة مختصرة من النظام — انقر أي بطاقة للانتقال مباشرة.", "A quick snapshot. Select any card to open it."],
  ["وصول متكرّر لتشغيل اليوم خارج التقارير فقط.", "Daily shortcuts beyond report review."],
  ["مراجعة المعلقة فقط", "Pending reviews only"],
  ["عرض المحطات", "View stations"],
  ["التقارير اليومية للفنيين", "Technician daily reports"],
  ["إعادة فحص الموقع", "Recheck location"],
  ["برنامج التنفيذ", "Treatment program"],
  ...
  ["استخدم QR المنطقة الصادر من لوحة الإدارة.", "Use the area QR code generated from the admin dashboard."],
