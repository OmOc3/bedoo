...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: t.analyticsPage.metaTitleManager };
}
...
function RangeFilter({
  ...
  return (
    <form
      ...
      action="/dashboard/manager/analytics"
    >
...
export default async function ManagerAnalyticsPage({ searchParams }: ManagerAnalyticsPageProps) {
  ...
  return (
    <DashboardShell role="manager">
      <PageHeader backHref="/dashboard/manager" description={pageDescription} title={ap.pageTitle} />
