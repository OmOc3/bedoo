...
const arabicStrings = {
  ...
  i18n: {
    ...
    scan: {
      ...
      qrOnlyNote:
        'لتسجيل زيارة صحيحة يجب مسح رمز QR على المحطة. تم إخفاء قائمة المحطات القريبة عمدًا حتى لا يُفتح تقرير دون مسح.',
    ...
    validation: {
      ...
      passwordRequired: 'كلمة المرور مطلوبة.',
      pestTypesRequired: 'اختر نوعاً واحداً على الأقل من برنامج التنفيذ.',
    ...
    report: {
      ...
      executionProgramTitle: 'برنامج التنفيذ',
    ...
    settings: {
      ...
      profileUpdateFailed: 'تعذر التحديث.',
...
const englishStrings: LocaleStrings = {
  ...
  i18n: {
    ...
    brand: {
      ...
      nameArabic: 'EcoPest',
      tagline: 'Clear field operations for bait stations and inspection teams',
      taglineArabic: 'Clear field operations for bait stations and inspection teams',
    },
    actions: {
      back: 'Back',
    ...
    scan: {
      ...
      invalidQr: 'A QR code was scanned, but it is not an EcoPest station link.',
      instruction: 'Point the camera at the station QR code',
      qrOnlyNote:
        'Scan the QR code on the station for a valid visit. The nearby-stations list is hidden on purpose so reports cannot be opened without scanning.',
    ...
    validation: {
      ...
      passwordRequired: 'Password is required.',
      pestTypesRequired: 'Choose at least one pest category for the execution program.',
    ...
    report: {
      ...
      executionProgramTitle: 'Execution program',
